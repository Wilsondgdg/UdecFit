// ================================
// 🔹 UdecFit Cloud Functions (Compatibles con Firebase v6+)
// ================================
...
// Inicialización Firebase Admin (usa credenciales locales si existen)
try {
  initializeApp();
...
// 📦 CREAR BACKUP
// ========================================================
exports.crearBackup = onRequest(async (req, res) => {
...
// 🔁 RESTAURAR BACKUP
// ========================================================
exports.restaurarBackup = onRequest(async (req, res) => {
  res.set("Access-Control-Allow-Origin", "*");
  res.set("Access-Control-Allow-Methods", "GET, POST, OPTIONS");
  res.set("Access-Control-Allow-Headers", "Content-Type, Authorization");
...
// 📋 LISTAR BACKUPS
// ========================================================
exports.listarBackups = onRequest(async (req, res) => {
  res.set("Access-Control-Allow-Origin", "*");
  res.set("Access-Control-Allow-Methods", "GET, POST, OPTIONS");
  res.set("Access-Control-Allow-Headers", "Content-Type, Authorization");
